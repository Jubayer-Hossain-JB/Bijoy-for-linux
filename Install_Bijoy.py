...
class UnicodeEngine(IBus.EngineSimple):
    def __init__(self, bus, object_path):
        ...
        self.pressbackspace = PressBackspace(self)
    ...
    def send_backspace(self, count):
        self.pressbackspace.exec(count)
...
<!-- filename: bijoy_uni.xml -->
<component>
	<name>org.freedesktop.IBus.bijoy_JB</name>
	<description>Bangla Bijoy Unicode Keyboard</description>
	<exec>/usr/bin/python3 /usr/share/ibus/engine/bijoyJBengine.py</exec>
	<author>Jubayer Hossain</author>
	<engines>
		<engine>
		...
		<engine>
			<name>bijoy:classic</name>
			<longname>Bijoy Classic</longname>
			<language>bn_BD</language>
			<symbol>bn</symbol>
			<icon>ibus-keyboard</icon>
			<rank>99</rank>
...
"""
with open('/usr/share/ibus/component/bijoyJB.xml', 'w') as f: f.write(component)
with open('/usr/share/ibus/engine/bijoyJBengine.py', 'w') as f: f.write(script)

print('\033[92m'+'[Installation Complete]'+'\033[0m')
print('\033[93m'+'Restart your IBus by running: sudo ibus restart'+'\033[0m')
print('\033[93m'+'Then add the keyboard layouts from keyboard settings'+'\033[0m')
